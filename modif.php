...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    ...
    <body >
        ...
        <center><form action="modif.php"  method="post">
                <p>
...
if
 (isset($_POST['numserie']) AND isset($_POST['ref']) AND isset($_POST['marque']) AND isset($_POST['capdisk'])AND isset($_POST['couleur']) AND isset($_POST['processeur']) AND isset($_POST['autonomie']) AND isset($_POST['taille']) AND isset($_POST['prix']) AND isset($_POST['stock'])) {
    ...
    $req = $bdd->prepare('update Lawani SET numserie=:numserie, ref=:ref, marque=:marque, capdisk=:capdisk, couleur=:couleur, processeur=:processeur, autonomie=:autonommie, taille=:taille, prix=:prix, stock=:stock where numserie=:numserie');
    $req->execute(array(
